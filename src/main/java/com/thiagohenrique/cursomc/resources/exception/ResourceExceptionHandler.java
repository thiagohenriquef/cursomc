package com.thiagohenrique.cursomc.resources.exception;
...
import com.thiagohenrique.cursomc.services.exception.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> amazonService(AmazonServiceException e, HttpServletRequest request) {
		...
		StandardError err = new StandardError(System.currentTimeMillis(), code.value(), "Erro do Amazon Service", e.getMessage(), request.getRequestURI());
	...
	public ResponseEntity<StandardError> amazonS3(AmazonS3Exception e, HttpServletRequest request) {
		StandardError err = new StandardError(System.currentTimeMillis(), HttpStatus.BAD_REQUEST.value(), "Erro do Amazon Service", e.getMessage(), request.getRequestURI());
		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(err);
	}
}
